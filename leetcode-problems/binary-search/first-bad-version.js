...
Input: n = 5, bad = 4 Output: 4 Explanation: call isBadVersion(3) -> false call
...
const solution = (isBadVersion) => {
  const search = (upper,
    ...
    if (isBadVersion(middle)) {
      return !isBadVersion(middle - 1) ? middle : search(middle - 1, lower);
    }

    return search(upper, middle + 1);
  };
