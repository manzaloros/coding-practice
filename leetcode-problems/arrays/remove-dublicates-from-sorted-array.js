...
const removeDuplicates = (nums) => {
  ...
  let i = 0;
  /*
		nums[j] will track duplicates
		If nums[j] and nums[i] don't equal, you increment i and set nums[i] to be
		nums[j] because you know the nums will be in order since it's ascending
	*/
